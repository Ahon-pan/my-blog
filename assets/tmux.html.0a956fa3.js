import{_ as t,o as n,c as s,a}from"./app.4bbb0959.js";const e={},d=a(`<h1 id="tmux" tabindex="-1"><a class="header-anchor" href="#tmux" aria-hidden="true">#</a> tmux</h1><blockquote><p>prefix: ctrl + b\u5728\u914D\u7F6E\u5DF2\u6539\u6210ctrl + f</p></blockquote><h2 id="\u56DE\u8BDD\u5B58\u50A8" tabindex="-1"><a class="header-anchor" href="#\u56DE\u8BDD\u5B58\u50A8" aria-hidden="true">#</a> \u56DE\u8BDD\u5B58\u50A8</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u4FDD\u5B58\u4F1A\u8BDD</span>
prefix ctrl+s
<span class="token comment"># \u6062\u590D\u4F1A\u8BDD</span>
prefix ctrl+r
</code></pre></div><h2 id="\u5E38\u7528\u547D\u4EE4" tabindex="-1"><a class="header-anchor" href="#\u5E38\u7528\u547D\u4EE4" aria-hidden="true">#</a> \u5E38\u7528\u547D\u4EE4</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u65B0\u5EFA\u4F1A\u8BDD</span>
...
</code></pre></div><h3 id="\u5B57\u4F53\u56FE\u6807" tabindex="-1"><a class="header-anchor" href="#\u5B57\u4F53\u56FE\u6807" aria-hidden="true">#</a> \u5B57\u4F53\u56FE\u6807</h3><p>\u6267\u884C\u4EE5\u4E0B\u6307\u4EE4\u5B89\u88C5\u5B57\u4F53\u56FE\u6807\u5230\u7CFB\u7EDF\u4E2D\uFF0C\u6709\u4E9B\u98CE\u683C\u9700\u8981\u56FE\u6807\u65F6\u5C31\u53EF\u4EE5\u6B63\u5E38\u663E\u793A\u4E86</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span>
...
</code></pre></div><blockquote><p>items2\u9700\u8981\u5728perference =&gt; profile =&gt; text:</p><p>\u2705 Use built-in Powerline glyphs + Font \u9009\u62E9</p></blockquote><h3 id="\u5B89\u88C5\u98CE\u683C" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5\u98CE\u683C" aria-hidden="true">#</a> \u5B89\u88C5\u98CE\u683C</h3><ol><li><p>Clone \u9879\u76EE\u4EE3\u7801</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/odedlaz/tmux-onedark-theme
</code></pre></div></li><li><p>\u5220\u9664\u539F~/.tmux.conf\u6587\u4EF6\uFF08\u6CE8\u610F\u4E0D\u662F\u5220\u9664\u5185\u5BB9\uFF0C\u56E0\u4E3A\u5B58\u5728\u7684.tmux.conf\u53EF\u80FD\u662F\u8F6F\u94FE\u63A5\uFF09\uFF0C\u7136\u540E\u65B0\u5EFA\u914D\u7F6E\u6587\u4EF6 <code>~/.tmux.conf</code> \u6DFB\u52A0\u4EE5\u4E0B\u5185\u5BB9\uFF0C\u5982\u679C\u60F3\u663E\u793A\u5B8C\u6574\u65E5\u671F\u5C31\u5C06\u524D2~4\u884C\u6CE8\u91CA\u6389\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code>run-shell ~/tmux-onedark-theme/tmux-onedark-theme.tmux
...
</code></pre></div></li><li><p>\u52A0\u8F7D\u914D\u7F6E</p><div class="language-bash ext-sh"><pre class="language-bash"><code>tmux source-file ~/.tmux.conf
</code></pre></div></li></ol><h2 id="\u603B\u4F53\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#\u603B\u4F53\u914D\u7F6E" aria-hidden="true">#</a> \u603B\u4F53\u914D\u7F6E</h2><div class="language-bash ext-sh"><pre class="language-bash"><code>run-shell ~/tmux-onedark-theme/tmux-onedark-theme.tmux
...
</code></pre></div>`,35),r=[d];function o(l,p){return n(),s("div",null,r)}var i=t(e,[["render",o],["__file","tmux.html.vue"]]);export{i as default};
