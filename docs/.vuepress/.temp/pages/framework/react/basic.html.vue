...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你必须谨慎对待 JSX 回调函数中的 <code v-pre>this</code>，在 JavaScript 中，class 的方法默认不会绑定 <code v-pre>this</code>。如果你忘记绑定 <code v-pre>this.handleClick</code> 并把它传入了 <code v-pre>onClick</code>，当你调用这个函数的时候 <code v-pre>this</code> 的值为 <code v-pre>undefined</code>。</p>
<p>这并不是 React 特有的行为；这其实与 JavaScript 函数工作原理有关。通常情况下，如果你没有在方法后面添加 <code v-pre>()</code>，例如 <code v-pre>onClick={this.handleClick}</code>，你应该为这个方法绑定 <code v-pre>this</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="custom-container tip"><p class="custom-container-title">this</p>
<p>JSX 语法中的 this 指向当前组件</p>
</div>
<ul>
<li>
<p>JSX 中的 this 执行当前 Reack 组件,所以 onClick = { this.handleClick }可以拿到当前组件的函数</p>
</li>
<li>
<p>class 定义中，当定义 React 组件时，<code v-pre>extends React.Component</code>时，不会将<code v-pre>this</code>继承下来。所以 handClick 函数中如果使用<code v-pre>this</code>是<code v-pre>undefined</code>。 以下两种方式可以指定<code v-pre>this</code>:</p>
<ol>
<li><code v-pre>this.handleClick = this.handleClick.bind(this)</code> ，推荐这种在构造函数绑定的方式</li>
<li><code v-pre>&lt;button onClick={this.handleClick.bind(this)}&gt;&lt;/button&gt;</code></li>
</ol>
</li>
<li>
<p>ES6 中的 arrow function，默认在定义的时候会绑定<code v-pre>this</code>, 指向了当前事件触发的上下文</p>
<p><code v-pre>&lt;div onScroll={ ()=&gt; {this.scroll() } } className=&quot;field-wrap&quot;&gt;&lt;/div&gt;</code></p>
</li>
</ul>
...
<div class="custom-container tip"><p class="custom-container-title">progressive web application</p>
<p>在 https 协议的服务器上，在用户二次访问网页的，即使是断网也能够访问，serviceWorker 能够缓存网页</p>
</div>
<div class="custom-container tip"><p class="custom-container-title">mainfest.json</p>
<p>如果配置了 pwa 设置，那么便可以把网页创建一个桌面快捷方式进行访问</p>
</div>
<p>icons src 设置了桌面快捷图标的 icon</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="reactdom-render" tabindex="-1"><a class="header-anchor" href="#reactdom-render" aria-hidden="true">#</a> ReactDOM.render</h3>
<ul>
<li>ReactDOM 的 render 方法能够实现将一个 React 组件挂载到 DOM 节点上</li>
<li>ReactDOM 展示组件内容的时候，<code v-pre>&lt;App /&gt;</code>使用了 JSX 语法，必需引入 React，才能进行编译</li>
</ul>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jsx-语法" tabindex="-1"><a class="header-anchor" href="#jsx-语法" aria-hidden="true">#</a> JSX 语法</h3>
<ul>
<li>
<p>JSX 语法直接写标签，不需要引号包裹</p>
...
<li>
<p>JSX 语法中的标签不仅可以是<strong>原生标签</strong>，也可以使用<strong>组件</strong>，组件开头必需<strong>大写字母</strong>开头<code v-pre>&lt;App /&gt;</code>，Fragment 也是一个组件</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> App <span class="token keyword">from</span> <span class="token string">'./App'</span><span class="token punctuation">;</span> <span class="token comment">// 大写字母开头</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token punctuation">{</span>
  <span class="token comment">//单行注释要把花括号单独放一行</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>引入和添加 class, for 等属性</p>
<div class="custom-container tip"><p class="custom-container-title">关键字</p>
<p>class 使用 className, for 使用 htmlFor</p>
</div>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>label</span> <span class="token attr-name">htmlFor</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>insertArea<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token plain-text">输入内容</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>label</span><span class="token punctuation">></span></span>
...
<li>
<p>innerHtml</p>
<p>外层花括号表示 JSX 语法，内层花括号表示接受一个对象</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>li</span>
...
<h3 id="immutable" tabindex="-1"><a class="header-anchor" href="#immutable" aria-hidden="true">#</a> immutable</h3>
<div class="custom-container tip"><p class="custom-container-title">immutable</p>
<p>react 建议 state 不允许我们做任何的改变（直接改变会影响性能）</p>
<p>可以考虑拷贝一个副本, 然后操作赋值 [...this.state.list] ）</p>
</div>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>  <span class="token function">handleItemDelete</span><span class="token punctuation">(</span><span class="token parameter">index</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="拆分组件和组件传值" tabindex="-1"><a class="header-anchor" href="#拆分组件和组件传值" aria-hidden="true">#</a> 拆分组件和组件传值</h3>
<div class="custom-container tip"><p class="custom-container-title">组件</p>
<p>在 constructor 里面做 this 统一绑定，会比在 jsx 中绑定的性能好</p>
<p>父组件通过属性向子组件传值，子组件通过 props 接收</p>
<p>子组件通过属性获取父组件方法，调用向外传递事件（父组件在传递方法时, 要记得绑定父组件的 this）</p>
<p>setState 可以传递一个函数实现异步，并且带来性能提升，函数参数 prevState(修改之前的 state)</p>
</div>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token comment">// TodoList.js</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token comment">// TodoItem.js</span>
...
<ul>
<li>
<p>命名式开发: 直接操作 dom（jQuery、原生），声名式开发: 面向数据编程（React）</p>
</li>
<li>
<p>可以与其它框架并存，React 只影响其绑定的原生 dom 标签下的区域</p>
</li>
<li>
<p>组件化（React 的组件首字母大写，属性传值，方法传递）</p>
</li>
<li>
<p>单向数据流，子组件不允许改变父组件的值（只读，当数据被多个子组件共用且允许被子组件改变数据时，会导致维护困难）</p>
</li>
<li>
<p>视图层框架（需要 redux 等其它辅助状态管理）</p>
</li>
<li>
<p>函数式编程（有利于单元测试）</p>
</li>
...
<h3 id="proptypes-与-defaultprops" tabindex="-1"><a class="header-anchor" href="#proptypes-与-defaultprops" aria-hidden="true">#</a> PropTypes 与 DefaultProps</h3>
<ul>
<li>
<p>使用</p>
<p>实现<strong>类型校验</strong>(开发环境下的 warning)</p>
</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>isRequired 实现必传<code v-pre>test: PropTypes.string.isRequired</code></p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>Warning: Failed prop type: The prop <span class="token variable"><span class="token variable">`</span><span class="token builtin class-name">test</span><span class="token variable">`</span></span> is marked as required <span class="token keyword">in</span> <span class="token variable"><span class="token variable">`</span>TodoItem<span class="token variable">`</span></span>, but its value is <span class="token variable"><span class="token variable">`</span>undefined<span class="token variable">`</span></span><span class="token builtin class-name">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>使用 defaultProps<strong>提供默认值</strong>(例如在 isRequired 下)</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>TodoItem<span class="token punctuation">.</span>defaultProps <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="props、state-与-render-函数" tabindex="-1"><a class="header-anchor" href="#props、state-与-render-函数" aria-hidden="true">#</a> Props、State 与 render 函数</h3>
<ul>
<li>当组件当中的 Props 或者 State 发生改变的时候，会触发 render 函数重新执行</li>
<li>当父组件的 render 函数被运行时，它的子组件的 render 都将被重新执行</li>
</ul>
<h3 id="什么是虚拟-dom" tabindex="-1"><a class="header-anchor" href="#什么是虚拟-dom" aria-hidden="true">#</a> 什么是虚拟 DOM</h3>
<h4 id="方案-1" tabindex="-1"><a class="header-anchor" href="#方案-1" aria-hidden="true">#</a> 方案 1</h4>
<ol>
<li>state 数据</li>
<li>模板 （render 函数中返回的 JSX）</li>
<li>数据 + 模板 = 真实的 DOM 显示</li>
<li>state 发生改变</li>
<li>数据 + 模板 = 真实的 DOM，替换原始的 DOM</li>
</ol>
<div class="custom-container warning"><p class="custom-container-title">缺陷</p>
<ul>
<li>第一次生成了一个完整的 DOM 片段</li>
<li>第二次生成了一个完整的 DOM 片段</li>
<li>第二次生成的 DOM 替换第一次的 DOM，非常耗性能</li>
</ul>
</div>
<h4 id="方案-2" tabindex="-1"><a class="header-anchor" href="#方案-2" aria-hidden="true">#</a> 方案 2</h4>
<ol>
<li>state 数据</li>
<li>JSX 模板</li>
<li>数据 + 模板 结合，生成真实的 DOM，来显示</li>
<li>state 发生改变</li>
<li>数据 + 模板 结合，生成真实的 DOM，并不直接替换原始的 DOM</li>
<li>新的 DOM（DocumentFragment 文档碎片）和原始的 DOM 做对比，找差异、</li>
<li>找出 input 框发生了变化</li>
<li>只用新的 DOM 中的 input 元素，替换掉老的 DOM 中的 input 元素</li>
</ol>
<div class="custom-container tip"><p class="custom-container-title">结果</p>
<ul>
<li>只修改部分 DOM 元素节约了一部分性能</li>
<li>对比 DOM 的过程又损耗了一部分性能</li>
<li>性能提升并不明显</li>
</ul>
</div>
<h4 id="方案-3" tabindex="-1"><a class="header-anchor" href="#方案-3" aria-hidden="true">#</a> 方案 3</h4>
<ol>
<li>
<p>state 数据</p>
</li>
...
<li>
<p>数据 + 模板 结合，生成真实的 DOM，来显示</p>
<p><code v-pre>&lt;div id='abc'&gt;&lt;span&gt;hello world&lt;/span&gt;&lt;/div&gt;</code></p>
</li>
<li>
<p>生成虚拟 DOM（虚拟 DOM 是一个数组结构的对象，用它开描述真实 DOM）</p>
<p><code v-pre>['div',{id:'abc'},['span',{},'hello world']]</code></p>
</li>
<li>
<p>state 发生变化</p>
</li>
<li>
<p>生成新的虚拟 DOM</p>
<p><code v-pre>['div',{id:'abc'},['span',{},'bye bye']]</code></p>
</li>
<li>
<p>比较原始虚拟 DOM 和新的虚拟 DOM 的区别，找到区别是 span 中的内容</p>
</li>
<li>
<p>直接操作 DOM，改变 span 中的内容</p>
</li>
</ol>
<div class="custom-container tip"><p class="custom-container-title">优化</p>
<ul>
<li>第 4 步，生成虚拟 DOM 损耗了一些性能，但是生成 JS 对象的虚拟 DOM 与生成真实 DOM 的损耗相比是很小的（js 创建 js 对象很简单，创建 DOM 的时候需要调用 WebApplication 级别的 API 的损耗就比较大）</li>
<li>第 6 步生成虚拟 DOM 对比方案 2 第 5 步生成 DOM 极大提升了性能</li>
<li>第 7 步比较 JS 对象，和真实 DOM 的对比也极大提升了性能</li>
</ul>
</div>
<h3 id="虚拟-dom-深入" tabindex="-1"><a class="header-anchor" href="#虚拟-dom-深入" aria-hidden="true">#</a> 虚拟 DOM 深入</h3>
<ul>
<li>
<p>react 的实现是在生成虚拟 DOM 后才生成真实 DOM</p>
</li>
<li>
<p>JSX =&gt; createElement =&gt; 虚拟 DOM（JS 对象） =&gt; 真实的 DOM</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	<span class="token keyword">return</span> <span class="token punctuation">(</span>
...
<div class="custom-container tip"><p class="custom-container-title">虚拟 DOM 的优点</p>
<ul>
<li>
<p>性能提升</p>
</li>
<li>
<p>跨端应用得以实现。React Native</p>
<p>DOM 只存在于浏览器，虚拟 DOM 作为 JS 对象在原生应用和浏览器都可以复用</p>
</li>
</ul>
</div>
<h3 id="虚拟-dom-中的-diff-算法" tabindex="-1"><a class="header-anchor" href="#虚拟-dom-中的-diff-算法" aria-hidden="true">#</a> 虚拟 DOM 中的 diff 算法</h3>
<p>比较虚拟 DOM 区别的算法（第 7 步）</p>
<ul>
<li>
<p>setState 作为异步函数提供了多个 state 更新（很短间隔时间内）只执行一次 setState，一次虚拟 DOM 的比对提升性能</p>
<p><img src="https://raw.githubusercontent.com/caffreygo/static/main/blog/react/diff.png" alt=""></p>
</li>
<li>
<p>同级比较，两个虚拟 DOM 的比对首先是同级的比对，第一层、第二层......如果有一级不同则不再比较，直接替换后面的全部 DOM。（虽然可能会造成 DOM 渲染的浪费，但是大大减少了两个虚拟 DOM 之间对比算法的性能损耗）</p>
</li>
<li>
<p>每个虚拟 DOM 节点的比较通过 key 值做关联（比较性能提升的前提，要保证前后虚拟 DOM 前后的 key 值一致，如果使用 index 作为 key 值就无法保证前后 key 值的一致，失去了 key 值存在的意义）</p>
<p><img src="https://raw.githubusercontent.com/caffreygo/static/main/blog/react/key.PNG" alt=""></p>
</li>
</ul>
<h3 id="react-中-ref-的使用" tabindex="-1"><a class="header-anchor" href="#react-中-ref-的使用" aria-hidden="true">#</a> React 中 ref 的使用</h3>
<h4 id="dom-获取" tabindex="-1"><a class="header-anchor" href="#dom-获取" aria-hidden="true">#</a> DOM 获取</h4>
<p>（在 React 中除了 e.target 可以获取到 DOM 元素之外，ref 也可以）</p>
<p>ref 参数等于一个函数(箭头函数传递 this)，如下我们构建了一个 ref 的引用（this.inopt），指向 input 这个节点</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span>
  <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>insertArea<span class="token punctuation">"</span></span>
  <span class="token attr-name">className</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>input<span class="token punctuation">"</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="setstate-异步问题" tabindex="-1"><a class="header-anchor" href="#setstate-异步问题" aria-hidden="true">#</a> setState 异步问题</h4>
<ul>
<li>
<p>ref 与 setState 共同使用可能出现的问题，setState 是异步函数不会立即执行</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token comment">// jsx</span>
...
<p><img src="https://raw.githubusercontent.com/caffreygo/static/main/blog/react/ref.png" alt=""></p>
<ul>
<li>
<p>如果希望在 setState 后获取到正确的 DOM，setState 接受第二个参数，是执行完的回调函数</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token function">handleBtnClick</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>state<span class="token punctuation">.</span>inputValue<span class="token punctuation">.</span><span class="token function">trim</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>length <span class="token operator">===</span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token keyword">return</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">setState</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">prevState</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">(</span><span class="token punctuation">{</span>
        <span class="token literal-property property">list</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token operator">...</span>prevState<span class="token punctuation">.</span>list<span class="token punctuation">,</span> prevState<span class="token punctuation">.</span>inputValue<span class="token punctuation">]</span><span class="token punctuation">,</span>
        <span class="token literal-property property">inputValue</span><span class="token operator">:</span> <span class="token string">''</span>
...
<div class="custom-container tip"><p class="custom-container-title">生命周期函数</p>
<ul>
<li>在某一个时刻组件会自动执行的函数</li>
<li>render 函数需要定义</li>
<li>state 和 props 发生改变时 render 函数自动执行；父组件的 render 函数重新执行时，子组件的 render 函数也会自动执行</li>
</ul>
</div>
<p><img src="https://raw.githubusercontent.com/caffreygo/static/main/blog/react/lifeFunc.PNG" alt=""></p>
<ul>
<li>
<p>componentWillMount：在组件即将被挂载到页面的时刻自动执行</p>
</li>
<li>
<p>componentDidMount：组件被挂载到页面之后，自动执行</p>
</li>
<li>
<p>shouldComponentUpdate：在组件更新之前会被自动执行 (return Boolean)</p>
<p>由返回的布尔值确定组件是否需要被更新</p>
</li>
<li>
<p>componentWillUpdate：组件被更新之前，他会被自动执行，但是它在 shoudComponentUpdate 之后被执行，由 shoudComponentUpdate 的返回值确定是否执行</p>
</li>
<li>
<p>componentDidUpdate：在组件更新之后自动执行</p>
</li>
<li>
<p>componentWillReceiveProps：当一个组件从父组件接收参数，只要父组件的 render 函数被执行了，这个函数就会被执行</p>
<p>如果这个组件第一次存在于父组件中，不会执行；如果这个组件已经存在于父组件中，才会执行</p>
</li>
<li>
<p>componentWillUnmount：当组件即将从页面中剔除时执行</p>
</li>
</ul>
<h3 id="生命周期函数的使用" tabindex="-1"><a class="header-anchor" href="#生命周期函数的使用" aria-hidden="true">#</a> 生命周期函数的使用</h3>
<ul>
<li>
<p>性能优化--shouldComponentUpdate：父组件 render 执行时，子组件的 render 函数也会执行。例如在 TodoList 中，输入框的改变导致了子组件 Item 的 render 函数重新执行，但是其实子组件只需要在 btnClick 时才需要执行：</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token function">shouldComponentUpdate</span><span class="token punctuation">(</span><span class="token parameter">nextProps<span class="token punctuation">,</span> nextState</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<li>
<p>AJAX--componentDidMount：只在组件的生命周期中执行一次，考虑各种情况，这个最合适</p>
</li>
</ul>
<h3 id="charles-数据-mock" tabindex="-1"><a class="header-anchor" href="#charles-数据-mock" aria-hidden="true">#</a> Charles 数据 mock</h3>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token function">componentDidMount</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="react-中的-css-动画" tabindex="-1"><a class="header-anchor" href="#react-中的-css-动画" aria-hidden="true">#</a> React 中的 css 动画</h3>
<ul>
<li>
<p>css3 的 transition 的过渡效果</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> Component<span class="token punctuation">,</span> Fragment <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token string">'./style.css'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.show</span> <span class="token punctuation">{</span>
...
<li>
<p>css 的动画效果@keyframes</p>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token selector">.show</span> <span class="token punctuation">{</span>
...
<h3 id="react-transition-group" tabindex="-1"><a class="header-anchor" href="#react-transition-group" aria-hidden="true">#</a> react-transition-group</h3>
<ul>
<li>CSSTransition 实现 class</li>
<li>classNames 指定类名开头</li>
<li>unmountOnExit 在 exit 后不渲染 DOM</li>
<li>钩子函数实现 js</li>
<li><code v-pre>appear={true}</code>实现入场动画的第一帧 （fade-appear,fade-appear-active）</li>
</ul>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> React<span class="token punctuation">,</span> <span class="token punctuation">{</span> Component<span class="token punctuation">,</span> Fragment <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token comment">/* 入场动画 */</span>
...
<ol>
<li>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>.fade-enter-done {
    opacity: 1;
    color: red
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">CSSTransition</span></span>
...
<ul>
<li>
<p>TransitionGroup 可以在外层包裹实现多个动画的实现</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">TransitionGroup</span></span><span class="token punctuation">></span></span><span class="token plain-text">
