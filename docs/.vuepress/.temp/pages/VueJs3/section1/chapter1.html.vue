...
<div class="custom-container tip"><p class="custom-container-title">Vue.js</p>
<ul>
<li>性能与可维护性之间的取舍</li>
<li>运行时与编译时之间的取舍</li>
</ul>
</div>
<h2 id="命令式与声明式" tabindex="-1"><a class="header-anchor" href="#命令式与声明式" aria-hidden="true">#</a> 命令式与声明式</h2>
<p>视图层框架的范式通常分为<strong>命令式</strong>与<strong>声明式</strong></p>
<ul>
<li>
<p>命令式：关注过程，比如原生js的 DOM 操作、jQuery，按步操作</p>
...
<li>
<p>声明式：关注结果，比如Vuejs，用户需要的最终视图结果</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">@click</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>() => alert(<span class="token punctuation">'</span>ok<span class="token punctuation">'</span>)<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>hello world<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<p>🔥 Vue.js帮助我们封装了过程，它的内部实现一定是命令式的，但是暴露给用户的却更加声明式</p>
<h2 id="性能与可维护性的权衡" tabindex="-1"><a class="header-anchor" href="#性能与可维护性的权衡" aria-hidden="true">#</a> 性能与可维护性的权衡</h2>
<div class="custom-container tip"><p class="custom-container-title">声明式代码的性能不优于命令式代码的性能</p>
<ul>
<li>命令式代码的更新性能消耗：A</li>
<li>声明式代码的更新性能消耗：A + B</li>
</ul>
<p>A: 直接修改的性能消耗；B: 找出差异的性能消耗</p>
</div>
<p>🔥 虽然声明式代码的性能无法超越命令式代码，但是声明式代码具有更好的可维护性，无需用户参与整个过程的，只需要关心结果的视图。因此，在保持可维护性的同时让性能损失最小化。</p>
<h2 id="虚拟dom的性能" tabindex="-1"><a class="header-anchor" href="#虚拟dom的性能" aria-hidden="true">#</a> 虚拟DOM的性能</h2>
<p>🔖 声明式代码的关键在于，如果我们能<strong>最小化</strong>找出差异的性能消耗，就可以让声明式代码的性能无限接近于命令式代码。虽然这很难，但是这也正是虚拟 DOM 想要解决的问题。</p>
<h3 id="创建页面" tabindex="-1"><a class="header-anchor" href="#创建页面" aria-hidden="true">#</a> 创建页面</h3>
<p>innerHTML于虚拟DOM在创建页面时的性能：</p>
<table>
<thead>
<tr>
<th></th>
...
<p>新建页面时，innerHTML和虚拟DOM性能差距不大，都是在新建DOM</p>
<h3 id="更新页面" tabindex="-1"><a class="header-anchor" href="#更新页面" aria-hidden="true">#</a> 更新页面</h3>
<p>innerHTML于虚拟DOM在更新页面时的性能：</p>
<table>
<thead>
<tr>
<th></th>
...
<p>虚拟 DOM 只更新必要的 DOM，和页面大小无关；innerHTML 性能差的原因：在更新页面时，需要销毁所有旧 DOM，重新创建新 DOM，页面越大，性能越差</p>
<h3 id="对比总结" tabindex="-1"><a class="header-anchor" href="#对比总结" aria-hidden="true">#</a> 对比总结</h3>
<table>
<thead>
<tr>
<th>innerHTML</th>
...
<h2 id="运行时和编译时" tabindex="-1"><a class="header-anchor" href="#运行时和编译时" aria-hidden="true">#</a> 运行时和编译时</h2>
<h3 id="运行时" tabindex="-1"><a class="header-anchor" href="#运行时" aria-hidden="true">#</a> 运行时</h3>
<p>代码直接可以运行，没有编译的过程。缺点是不能分析提供的代码内容，进行对应的性能优化操作</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Render</span><span class="token punctuation">(</span><span class="token parameter">obj<span class="token punctuation">,</span> root</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="编译时" tabindex="-1"><a class="header-anchor" href="#编译时" aria-hidden="true">#</a> 编译时</h3>
<p>将代码进行分析转换为可执行的代码，可以分析用户内容。缺点是灵活性较差，必须编译后使用</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是运行时+编译时，compiler将代码编译成：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，也可以实现为纯编译时，compiler直接编译为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>🔥 Vue.js 是运行时 + 编译时架构，保证灵活性的基础上，通过分析，尽可能提升性能。编译器提供了代码提前分析的可能，Vue.js 使用编译器分析出动态数据，让渲染器在更新时能快速区分定位，相辅相成。</p>
</div></template>
